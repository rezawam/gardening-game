...
double perlin2d(double x, double y, double freq, int depth, int seed)
{
    SEED = seed;
    double  xa = x * freq;
    double  ya = y * freq;
...
{
    SDL_Color arrColors[] = {
    SDL_Color{0, 191, 255, 255},   // Light Blue
    SDL_Color{104, 232, 0, 255},  // Grass Green
    SDL_Color{225,225,70, 255}
    };
